...
const getStatusOption = (id: string) => statusOptions.value.find((o) => o.id === id);
...
const room = computed({
    get: () =>
        route.query.room ? parseInt(route.query.room as string) : null,
...
const pageOffset = computed({
    get: () =>
        route.query.page
            ? (parseInt(route.query.page as string) - 1) * 20
            : 0,
    set: (val) => {
                                ...
                                >
                                    <template #value="slotProps">
                                        <div v-if="slotProps.value">
                                            <Tag
                                                :value="getStatusOption(slotProps.value)?.name"
                                                :severity="
                                                    getStatusOption(slotProps.value)?.severity
                                                "
                                                class="h-5 !text-xs"
                                            ></Tag>
                                        </div>
