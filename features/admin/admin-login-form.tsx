...
export function AdminLoginForm() {
  ...
  return (
    <main className="mx-auto grid min-h-[calc(100svh-3.5rem)] max-w-7xl px-4 py-12 sm:px-6 lg:grid-cols-2 lg:items-center">
      <div className="border-b pb-10 lg:border-r lg:border-b-0 lg:pr-14"><p className="text-xs font-semibold text-red-600">ADMIN</p><h1 className="mt-3 text-4xl font-semibold sm:text-6xl">管理员登录</h1><p className="mt-5 max-w-md leading-7 text-muted-foreground">审批预约、维护校区与房间、管理管理员账号并查看使用数据。</p></div>
