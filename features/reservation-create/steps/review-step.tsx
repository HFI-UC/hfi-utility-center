...
export function ReviewStep({ catalog }: { catalog: BootstrapData }) {
  ...
  const rows = [[t("class"), className], [t("location"), location], [t("start"), format(values.startTime)], [t("end"), format(values.endTime)], [t("name"), values.studentName], [t("studentId"), values.studentId], [t("email"), values.email], [t("reason"), values.reason]]
  return <StepLayout eyebrow="05 / 05" title={t("reviewTitle")}>
