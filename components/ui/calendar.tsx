...
function Calendar({ className, classNames, components, showOutsideDays = true, ...props }: DayPickerProps) {
  return (
    <DayPicker
      ...
      classNames={{
        ...
        weekdays: "border-b",
        weekday: "h-9 w-10 text-center text-xs font-medium text-muted-foreground",
        week: "border-b last:border-b-0",
        day: "relative size-10 p-0 text-center text-sm",
        day_button: cn(buttonVariants({ variant: "ghost" }), "size-10 rounded-none p-0 font-normal aria-selected:opacity-100"),
