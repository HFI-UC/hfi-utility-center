...
export function SwissFooterBar() {
  return (
    <footer className="border-t">
      <div className="mx-auto grid h-10 max-w-[96rem] grid-cols-[1fr_auto_1fr] items-center px-4 font-mono text-[0.625rem] font-medium text-muted-foreground sm:px-8">
        <p>Made by MAKERs</p>
        <RegistrationMark />
