...
export const editClass = (id: number, name: string, campus: number) =>
  apiRequest("/class/edit", {
    method: "POST",
    ...jsonBody({ id, name, campus }),
  })
...
export const editRoom = (
  ...
  apiRequest("/room/edit", {
    method: "POST",
    ...jsonBody({ id, name, campus, enabled }),
  })
...
export const createPolicy = (
  ...
  apiRequest("/policy/create", {
    method: "POST",
    ...jsonBody({ room, days, startTime, endTime }),
  })
export const editPolicy = (
  ...
  apiRequest("/policy/edit", {
    method: "POST",
    ...jsonBody({ id, days, startTime, endTime }),
  })
