...
export const toggleApproverNotifications = (id: number) =>
  apiRequest("/approver/toggle-notification", {
    method: "POST",
    ...jsonBody({ id }),
  })
